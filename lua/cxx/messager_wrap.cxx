...
#define SWIGTYPE_p_Messager swig_types[0]
...
#define SWIG_name      "messager"
#define SWIG_init      luaopen_messager
#define SWIG_init_user luaopen_messager_user

#define SWIG_LUACODE   luaopen_messager_luacode
...
static int _wrap_new_Messager(lua_State* L) {
  {
    ...
    SWIG_check_num_args("Messager::Messager",0,0)
    result = (Messager *)new Messager();
    SWIG_NewPointerObj(L,result,SWIGTYPE_p_Messager,1); SWIG_arg++; 
    return SWIG_arg;
...
static int _wrap_Messager_say_hello(lua_State* L) {
  {
    int SWIG_arg = 0;
    Messager *arg1 = (Messager *) 0 ;
    
    SWIG_check_num_args("Messager::say_hello",1,1)
    if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Messager::say_hello",1,"Messager *");
    
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Messager,0))){
      SWIG_fail_ptr("Messager_say_hello",1,SWIGTYPE_p_Messager);
    }
...
static int _wrap_Messager_get_val(lua_State* L) {
  {
    int SWIG_arg = 0;
    Messager *arg1 = (Messager *) 0 ;
    double result;
    
    SWIG_check_num_args("Messager::get_val",1,1)
    if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Messager::get_val",1,"Messager *");
    
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Messager,0))){
      SWIG_fail_ptr("Messager_get_val",1,SWIGTYPE_p_Messager);
    }
    
    result = (double)(arg1)->get_val();
...
static int _wrap_Messager_set_val(lua_State* L) {
  {
    int SWIG_arg = 0;
    Messager *arg1 = (Messager *) 0 ;
    double arg2 ;
    
    SWIG_check_num_args("Messager::set_val",2,2)
    if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Messager::set_val",1,"Messager *");
    if(!lua_isnumber(L,2)) SWIG_fail_arg("Messager::set_val",2,"double");
    
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Messager,0))){
      SWIG_fail_ptr("Messager_set_val",1,SWIGTYPE_p_Messager);
    }
...
static swig_lua_method swig_Messager_methods[]= {
    { "say_hello", _wrap_Messager_say_hello},
    { "get_val", _wrap_Messager_get_val},
    { "set_val", _wrap_Messager_set_val},
    {0,0}
};
...
static swig_lua_class _wrap_class_Messager = { "Messager", "Messager", &SWIGTYPE_p_Messager,_proxy__wrap_new_Messager, swig_delete_Messager, swig_Messager_methods, swig_Messager_attributes, &swig_Messager_Sf_SwigStatic, swig_Messager_meta, swig_Messager_bases, swig_Messager_base_names };

static int _wrap_global_hello(lua_State* L) {
  {
    int SWIG_arg = 0;
    
    SWIG_check_num_args("global_hello",0,0)
    global_hello();
...
static swig_lua_method swig_SwigModule_methods[]= {
    { "global_hello", _wrap_global_hello},
    {0,0}
};
...
static swig_type_info _swigt__p_Messager = {"_p_Messager", "Messager *", 0, 0, (void*)&_wrap_class_Messager, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_Messager,
};

static swig_cast_info _swigc__p_Messager[] = {  {&_swigt__p_Messager, 0, 0, 0},{0, 0, 0, 0}};
